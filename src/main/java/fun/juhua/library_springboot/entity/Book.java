...
public class Book {
    ...
    @TableField(exist = false)
     //现有字段...
    private List<BookElectronicResource> electronicResources;  // 电子资源列表
    ...
    // getter和setter
    public List<BookElectronicResource> getElectronicResources() {
        return electronicResources;
    }

    public void setElectronicResources(List<BookElectronicResource> electronicResources) {
